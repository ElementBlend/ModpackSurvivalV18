ServerEvents.recipes(event => {
  ...
  event.shaped('croparia:croparia2', [
    'BAC',
    'ADA',
    'EAF'
  ], {
    ...
    C: 'minecraft:baked_potato',
    D: 'minecraft:baked_potato',
    E: 'minecraft:baked_potato',
    F: 'minecraft:baked_potato'
  })
  event.shaped('croparia:croparia3', [
    'BAC',
    'ADA',
    'EAF'
  ], {
    A: 'croparia:croparia2',
    B: 'minecraft:pumpkin_seeds',
    C: 'minecraft:melon_seeds',
    D: 'minecraft:wheat_seeds',
    E: 'minecraft:torchflower_seeds',
    F: 'minecraft:beetroot_seeds'
  })
  event.shaped('croparia:croparia4', [
    'BAC',
    'ADA',
    'EAF'
  ], {
    A: 'croparia:croparia3',
    B: 'minecraft:carrot',
    C: 'additionaladditions:fried_egg',
    D: 'minecraft:cooked_cod',
    E: 'minecraft:cooked_salmon',
    F: 'minecraft:cookie'
  })
  event.shaped('croparia:croparia5', [
    'BAC',
    'ADA',
    'EAF'
  ], {
    A: 'croparia:croparia4',
    B: 'minecraft:cooked_porkchop',
    C: 'minecraft:cooked_mutton',
    D: 'minecraft:cooked_beef',
    E: 'minecraft:cooked_chicken',
    F: 'minecraft:golden_apple'
  })
  event.shaped('croparia:croparia6', [
    'BAC',
    'ADA',
    'EAF'
  ], {
    A: 'croparia:croparia5',
    B: 'betternether:agave',
    C: 'betternether:golden_lumabus_seed',
    D: 'betternether:whispering_gourd_vine',
    E: 'betternether:lumabus_seed',
    F: 'betternether:black_apple_seed'
  })
  event.shaped('croparia:croparia7', [
    'BAC',
    'ADA',
    'EAF'
  ], {
    A: 'croparia:croparia6',
    B: 'betterend:blossom_berry_seed',
    C: 'betterend:shadow_berry',
    D: 'betterend:amber_root_seed',
    E: 'betterend:chorus_mushroom_seed',
    F: 'betterend:cave_pumpkin_seed'
  })
  ...
  event.shapeless('minecraft:dark_oak_log', ['croparia:fruit_dark_oak'])
  event.shapeless('minecraft:golden_apple', ['croparia:fruit_golden_apple'])
